...
@section('content')
    ...
    <div class="chakra-container css-n759ug">
        <div class="css-1u1s7a2 mb-4">
            <h1 class="chakra-heading text-blue"><b>OUR TEAM</b></h1>
        </div>
        <div class="css-1nu5w7e">
            @if (!empty($Ourteam))
                @foreach ($Ourteam as $item)
                    <div class="css-1f4mlr5" style="width:100%; border-width:5px;border-color:#ffffff;border-style:solid; border-radius:20px;">
